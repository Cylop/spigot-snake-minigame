...
public final class SemanticVersion implements Comparable<SemanticVersion> {
    ...
    /**
     * Build metadata tags (potentially empty, but never null). This is private
    ...
    public SemanticVersion(int major, int minor, int patch, String[] preRelease,
        ...
        if (major < 0 || minor < 0 || patch < 0) {
            throw new IllegalArgumentException("Versioning must be positive!");
        }
     ...
     * @throws ParseException if the versioning does not conform to the semver specs.
     */
